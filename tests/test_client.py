...
from khipu_tools.pykhipu.client import Client
...
class TestClient(TestCase):
    ...
    def test_make_signature(self):
        ...
        self.assertEqual(
            client._Client__make_signature(method, url),
            "A:bad6f7d155cafe89c1c69476cfc7d88891b0ed57180c2b3d004010f71f65e1eb",
        )
        self.assertEqual(
            client._Client__make_signature(method, url, params),
            "A:dd561da205892eb154fd390220ca111b59412be522bdb107f95795e70f9c322d",
        )
        self.assertEqual(
            client._Client__make_signature(method, url, params, data),
    ...
    def test_make_request(self):
        with patch("pykhipu.client.requests.request") as mock_request:
            ...
            response = client.make_request(
                "GET", "/test", {"test": "true"}, {"payload": "1234"}
            )
